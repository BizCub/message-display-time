...
value class ModData(private val project: Project) {
    ...
    val pub_start: String get() = propIfExist("pub_start", mc).toString()
    val pub_end: String get() = propIfExist("pub_end", mc).toString()
    ...
    fun propIfExist(key: String, keyFallback: String) = if (project.prop(key) != null) project.prop(key) else keyFallback
